...
import { ExternalLink, Download, ArrowLeft, User } from "lucide-react"
...
export default function Rodin() {
  ...
  const isMobile = useMediaQuery("(max-width: 768px)") // Fixed: Don't destructure the boolean return value
  ...
  const ExternalLinks = () => (
    <div className="flex items-center space-x-6">
      ...
      >
        <span className="mr-1">About Me</span>
    ...
    <div className="relative h-[100dvh] w-full">
      ...
      <div className="absolute inset-0 z-10 pointer-events-none">
        ...
        <div className="absolute top-6 left-6 pointer-events-auto">
          <h1 className="text-3xl text-white font-normal tracking-normal">Morpheus3D</h1>
          <p className="text-gray-400 text-sm mt-1 tracking-normal">Powered by Hyper3D Rodin</p>
          <p className="text-gray-400 text-sm mt-0.5 tracking-normal">Made by Arhaan Girdhar</p>
        </div>
